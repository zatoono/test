...
public class HelloStrutsDAO {
	...
	List<com.internousdev.webproj4.DTO.HelloStrutsDTO>helloStrutsDTOList = new ArrayList<HelloStrutsDTO>();
	...
	public List<HelloStrutsDTO> select(){
		...
		try {
			...
			while(rs.next()) {
				com.internousdev.webproj4.DTO.HelloStrutsDTO dto = new HelloStrutsDTO();
